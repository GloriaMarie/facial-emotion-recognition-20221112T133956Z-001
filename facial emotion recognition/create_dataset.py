# -*- coding: utf-8 -*-
"""
Edited on Wed Sept 30 00:40:47 2022
...
while(True):
    ...
    # show video stream
    cv2.putText(gray, "Q - Quit", (10, 12),cv2.FONT_HERSHEY_SIMPLEX, 0.45,(255,255,255), 2)
    cv2.putText(gray, "n - neutral", (10, 24),cv2.FONT_HERSHEY_SIMPLEX, 0.45,(255,255,255), 2)
    cv2.putText(gray, "h - happy", (10, 36),cv2.FONT_HERSHEY_SIMPLEX, 0.45,(255,255,255), 2)
    cv2.putText(gray, "s - sad", (10, 48),cv2.FONT_HERSHEY_SIMPLEX, 0.45,(255,255,255), 2)
    cv2.putText(gray, "a - angry", (10, 60),cv2.FONT_HERSHEY_SIMPLEX, 0.45,(255,255,255), 2)
    cv2.putText(gray, "f - fear", (10, 72),cv2.FONT_HERSHEY_SIMPLEX, 0.45,(255,255,255), 2)
    cv2.putText(gray, "d - disgust", (10, 84),cv2.FONT_HERSHEY_SIMPLEX, 0.45,(255,255,255), 2)
    cv2.putText(gray, "r - surprise", (10, 96),cv2.FONT_HERSHEY_SIMPLEX, 0.45,(255,255,255), 2)

    cv2.imshow('FACIAL EMOTION DETECTION',gray)
    ...
    if  key == ord('q'):
        ...
        capture_face_expression(face_expression,"fear",dataset_path)
        print("fear")
    elif key == ord('r'):
        capture_face_expression(face_expression,"surprise",dataset_path)
        print("surprise")
    elif key == ord('d'):
         capture_face_expression(face_expression,"disgust",dataset_path)
         print("disgust")    
