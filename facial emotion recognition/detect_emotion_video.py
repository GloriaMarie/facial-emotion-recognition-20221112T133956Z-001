"""
Edited  on Thu Mar 24 14:44:42 2022
...
labels=["happy","neutral","sad","anger","fear", "surprise", "disgust"]
...
while True:
	...
	for (box, pred) in zip(locs, preds):
		...
		if label == "happy":
			...
			cv2.putText(original_frame, label, (startX, startY - 10),cv2.FONT_HERSHEY_SIMPLEX, 0.45,(0,70,250), 2)
			cv2.rectangle(original_frame, (startX, startY), (endX, endY),(0,70,250), 2)     
		elif label == "fear":
			cv2.putText(original_frame, label, (startX, startY - 10),cv2.FONT_HERSHEY_SIMPLEX, 0.45,(255,0,0), 2)
			cv2.rectangle(original_frame, (startX, startY), (endX, endY),(255,0,0), 2)
		elif label == "surprise":
			cv2.putText(original_frame, label, (startX, startY - 10),cv2.FONT_HERSHEY_SIMPLEX, 0.45,(106,90,205), 2)
			cv2.rectangle(original_frame, (startX, startY), (endX, endY),(106,90,205), 2)
		elif label == "disgust":
			cv2.putText(original_frame, label, (startX, startY - 10),cv2.FONT_HERSHEY_SIMPLEX, 0.45,(255,165,0), 2)
			cv2.rectangle(original_frame, (startX, startY), (endX, endY),(255,165,0), 2)


	# show the output frame
	frame= cv2.resize(original_frame,(1000,490))
	cv2.imshow("facial emotion detection from video by shemyte", frame)
